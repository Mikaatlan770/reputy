          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            >
              ...
              >
                ...
                <Link
                  href="/health"
                  className="flex items-start gap-3 p-4 hover:bg-sky-50 transition-colors"
                >
                ...
                {/* Food - Coming soon */}
                <div className="flex items-start gap-3 p-4 cursor-not-allowed opacity-60">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500">Restauration</div>
                  </div>
                </div>
        ...
        >
          <div className="flex flex-col gap-2 pt-2">
            ...
            <div className="px-3 py-2">
              ...
              <Link
                href="/health"
                className="flex items-center gap-3 px-3 py-2 hover:bg-sky-50 rounded-lg"
              >
                <Stethoscope className="h-5 w-5 text-sky-600" />
                <div>
                  <div className="font-medium text-gray-900">Reputy Health</div>
            ...
            <Link
              href="/signup?plan=bronze"
              className="px-3 py-2 text-sm font-semibold text-white bg-primary-900 rounded-lg text-center"
            >
